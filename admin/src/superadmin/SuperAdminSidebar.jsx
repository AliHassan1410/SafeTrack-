...
export default function SuperAdminSidebar() {
  ...
  const handleLogout = () => {
    logout()
    // Always redirect to the main admin login — not to /SuperAdmin
    navigate('/login')
  }

  return (
    <aside className="sidebar" style={{ '--sidebar-accent': '#8b5cf6' }}>
      {/* Logo */}
      <div className="sidebar-logo">
        ...
        <div>
          <div className="sidebar-logo-title">SafeTrack</div>
          <div className="sidebar-logo-sub" style={{ color: '#a78bfa' }}>Super Admin</div>
        </div>
      </div>
      ...
      <div className="sidebar-bottom">
        ...
        <button className="sidebar-nav-item sidebar-logout" onClick={handleLogout}>
          ...
          <span className="sidebar-nav-label-text">Logout</span>
        </button>
      </div>
    </aside>
  )
