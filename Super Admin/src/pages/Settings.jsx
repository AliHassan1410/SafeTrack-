      ...
      case 'general':
        return (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <p className="settings-section-desc">Manage your basic system configuration and regional settings.</p>
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                <div className="setting-info">
                  ...
                  <p className="setting-desc">Set the primary timezone for timestamps across the dashboard.</p>
                </div>
              ...
              <div className="setting-item">
                <div className="setting-info">
                  ...
                  <p className="setting-desc">Primary language for the admin portal interface.</p>
                </div>
                <div className="setting-action">
                  <select 
                    className="setting-select"
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                <div className="setting-info">
                  ...
                  <p className="setting-desc">Automatically assign nearest available responders to high-priority incidents.</p>
                </div>
                <div className="setting-action">
      ...
      case 'notifications':
        return (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <p className="settings-section-desc">Control how and when you receive system alerts.</p>
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                <div className="setting-info">
                  ...
                  <p className="setting-desc">Browser notifications for incoming critical incidents.</p>
                </div>
                <div className="setting-action">
                  <label className="toggle-switch">
                    <input 
              ...
              <div className="setting-item">
                <div className="setting-info">
                  ...
                  <p className="setting-desc">Text messages for server downtime or catastrophic emergencies.</p>
                </div>
                <div className="setting-action">
                  <label className="toggle-switch">
                    <input 
      ...
      case 'security':
        return (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <p className="settings-section-desc">Manage your account security and data access.</p>
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                <div className="setting-info">
                  ...
                  <p className="setting-desc">Require an authenticator code when logging into the admin portal.</p>
                </div>
                <div className="setting-action">
                  <label className="toggle-switch">
                    <input 
            ...
            <div className="settings-group">
              ...
              <div className="setting-item">
                <div className="setting-info">
                  ...
                  <p className="setting-desc">Instantly revoke access to all active administrative sessions globally.</p>
                </div>
                <div className="setting-action">
      ...
      case 'system':
        return (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <p className="settings-section-desc">Technical information about your SafeTrack installation.</p>
    ...
    >
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Configure application behaviors and preferences</p>
        </div>
      </div>
